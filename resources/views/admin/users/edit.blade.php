        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="p-6 sm:p-8 space-y-6">
            ...
            <div class="pt-4 mt-2 border-t border-gray-100 dark:border-gray-700">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-sm font-bold text-gray-900 dark:text-gray-200 mb-2">Password Baru</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                            </div>
                            <input type="password" name="password" id="password" class="block w-full pl-11 pr-4 py-3 bg-gray-50 border-gray-200 text-gray-900 rounded-xl focus:ring-orange-500 focus:border-orange-500 transition-colors dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="Biarkan kosong jika tidak diubah">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" class="block w-full pl-11 pr-4 py-3 bg-gray-50 border-gray-200 text-gray-900 rounded-xl focus:ring-orange-500 focus:border-orange-500 transition-colors dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="Ulangi password">
                        </div>
                    </div>
                </div>
            </div>
