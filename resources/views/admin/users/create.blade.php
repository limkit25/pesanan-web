            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div x-data="{ show: false }">
                    ...
                    <div class="relative">
                        ...
                        <input x-bind:type="show ? 'text' : 'password'" name="password" id="password" class="block w-full pl-11 pr-10 py-3 bg-gray-50 border-gray-200 text-gray-900 rounded-xl focus:ring-orange-500 focus:border-orange-500 transition-colors dark:bg-gray-900 dark:border-gray-700 dark:text-white" placeholder="Min. 8 karakter" required>
