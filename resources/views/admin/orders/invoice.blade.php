...
<body>
    ...
    <div class="max-w-[800px] mx-auto mb-6 flex justify-between items-center no-print">
        ...
        <button onclick="window.print()" class="inline-flex items-center gap-2 px-6 py-2 bg-brand-500 text-white rounded-lg font-bold shadow-md hover:bg-brand-600 transition-colors">
    ...
    <div class="invoice-container">
        ...
        <div class="flex justify-between items-start mb-8">
            <div class="w-1/2 pr-4">
                ...
                <p class="font-bold text-gray-900 text-lg">{{ $order->user->name ?? 'Pelanggan Umum' }}</p>
