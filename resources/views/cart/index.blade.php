                                    ...
                                    <li class="py-3.5 flex items-center group first:pt-0 last:pb-0 gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center justify-between mt-2.5">
                                                <div class="flex items-center border border-gray-200 rounded-lg overflow-hidden bg-gray-50 max-w-fit shadow-inner">
                                                    <!-- Tombol Kurang (-) -->
                                                    ...
                                                    <form action="{{ route('cart.update', $cart->id) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('PATCH')
                                                         <input type="number" name="quantity" value="{{ $cart->quantity }}" min="1" onchange="this.form.submit()" class="text-gray-950 dark:text-white p-0 m-0 border-0 focus:ring-0 text-center" style="width: 36px; font-weight: 900; font-size: 14px; background: transparent;" onkeydown="if(event.key==='Enter'){event.preventDefault();this.form.submit();}">
                                                    </form>
                                                    ...
                                                    <form action="{{ route('cart.update', $cart->id) }}" method="POST" class="inline">
                                                        ...
                                                        @method('PATCH')
                                                        <input type="hidden" name="quantity" value="{{ $cart->quantity + 1 }}">
                                                        <button type="submit" class="px-3 py-1 text-gray-500 hover:bg-gray-200 hover:text-gray-700 transition-colors font-bold text-sm">+</button>
                                                    </form>
                                                </div>
